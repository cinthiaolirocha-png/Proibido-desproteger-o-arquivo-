...
local Window = redzlib:MakeWindow({
    Title = "veloz Hub💨 | Brookhaven RP 🏡 4.1",
    SubTitle = "by theo e Matheus ",
    SaveFolder = "vamos acabar com o web namoro"
  })
...
local Tab11 = Window:MakeTab({"premium ","gamepass"})
...
Tab1:AddDiscordInvite({
    Name = "veloz Hub Team",
    Description = "",
    Logo = "https://discord.gg/Kp5BPGFb8",
    Invite = "",
})
...
local Paragraph = Tab1:AddParagraph({"Criadores", "veloz Hub"})

local Paragraph = Tab1:AddParagraph({"créditos", "theo e Matheus"})


  
  Tab1:AddButton({
    Name = " - Copiar  o YouTube",
    Callback = function()
      setclipboard("https://www.youtube.com/@MrCinthia2011") -- Copia o @
      setclipboard("https://www.youtube.com/@MrCinthia2011") -- Copia o link também, se quiser só o @, remova esta linha
